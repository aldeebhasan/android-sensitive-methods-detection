...
public class ToneGenerator
{
    ...
    public ToneGenerator(final int streamType, final int volume) {
        throw new RuntimeException("Stub!");
    }
    
    public boolean startTone(final int toneType) {
        throw new RuntimeException("Stub!");
    }
    
    public native boolean startTone(final int p0, final int p1);
